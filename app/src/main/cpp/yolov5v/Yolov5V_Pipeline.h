...
class Detector_Yolov5v {
public: // NOLINT
  explicit Detector_Yolov5v(const std::string &modelDir, const std::string &labelPath,
...
class Yolov5V_Pipeline {
public: // NOLINT
  Yolov5V_Pipeline(const std::string &modelDir, const std::string &labelPath,
                   const int cpuThreadNum, const std::string &cpuPowerMode,
  ...
  std::vector<Object> Process(cv::Mat &rgbaImage);
...
private: // NOLINT
  std::shared_ptr<Detector_Yolov5v> detector_;
};
