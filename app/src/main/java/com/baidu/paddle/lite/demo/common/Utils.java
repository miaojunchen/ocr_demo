...
public class Utils {
    ...
    public static int createShaderProgram(String vss, String fss) {
        int vshader = GLES20.glCreateShader(GLES20.GL_VERTEX_SHADER); // 创建GL程序（顶点赵森器）
        ...
        int fshader = GLES20.glCreateShader(GLES20.GL_FRAGMENT_SHADER); // 创建GL程序 （片元着色器）
        ...
        GLES20.glAttachShader(program, vshader); //  将shader  附在GL程序上
        GLES20.glAttachShader(program, fshader);
        GLES20.glLinkProgram(program); // 链接GL程序
        GLES20.glDeleteShader(vshader);
        GLES20.glDeleteShader(fshader);
