...
public class CameraSurfaceView extends GLSurfaceView implements Renderer,
    ...
    protected int[] drawTexureId = {0,1};
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        GLES20.glGenTextures(1, camTextureId, 0); //创建纹理
        GLES20.glBindTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, camTextureId[0]);  // 绑定纹理
        ...
        vcCam2FBO = GLES20.glGetAttribLocation(progCam2FBO, "vPosition"); // 获取属性
        ...
        GLES20.glEnableVertexAttribArray(vcTex2Screen); // 启动对应的参数
    ...
    private void drawocrFrame() {
        ...
        GLES20.glUseProgram(progCam2FBO);  // 启用引用程序
        ...
        if (onTextureChangedListener != null) {
            ...
            boolean modified1 = onTextureChangedListener.onTextureChanged(ARGB8888ImageBitmap);
            if (modified1) {
//                targetTexureId = drawTexureId[0];
    ...
    public void openCamera() {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, drawTexureId[1]);
