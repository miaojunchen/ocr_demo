package com.baidu.paddle.lite.demo.opengl.egl;
...
public class EGLHelper {
     ...
     * @param eglContext
     */
    public EGLHelper(final EGLContext eglContext, final Object surface) {
    ...
    private boolean makeMyEGLCurrentSurface() {
        ...
        Log.d(TAG, "Rokid_Glass: makeMyEGLCurrentSurface success!!!!!!");
        return true;
    }
